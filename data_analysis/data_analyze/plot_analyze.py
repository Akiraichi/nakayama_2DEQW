...
class KLdivPlotter(BasicPlotter):
    def __init__(self):
        self.plot_style.y_label = "KL divergence"


class L1normPlotter(BasicPlotter):
    def __init__(self):
        self.plot_style.y_label = "L1 norm"


class L2normPlotter(BasicPlotter):
    def __init__(self):
        self.plot_style.y_label = "L2 norm"


class CCPlotter(BasicPlotter):
    def __init__(self):
        self.plot_style.y_label = "correlation coefficient"


def create_Plotter(plot_style):
    if plot_style.type == "KL_div":
        return KLdivPlotter()
    elif plot_style.type == "L1_norm":
        return L1normPlotter()
    elif plot_style.type == "L2_norm":
        return L2normPlotter()
    elif plot_style.type == "correlation coefficient":
        return CCPlotter()
    else:
        raise OSError
